...
class MoviesListUI extends StatefulWidget {
  final String type, value;
  const MoviesListUI({Key? key, required this.type, required this.value})
      : super(key: key);

  @override
  State<MoviesListUI> createState() => _MoviesListUIState();
}

class _MoviesListUIState extends State<MoviesListUI> {
