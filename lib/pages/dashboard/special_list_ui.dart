...
class SpecialListUI extends StatefulWidget {
  final String type, value;
  const SpecialListUI({Key? key, required this.type, required this.value})
      : super(key: key);
  @override
  State<SpecialListUI> createState() => _SpecialListUIState();
}

class _SpecialListUIState extends State<SpecialListUI> {
