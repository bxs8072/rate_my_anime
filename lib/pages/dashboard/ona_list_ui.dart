...
class OnaListUI extends StatefulWidget {
  final String type, value;
  const OnaListUI({Key? key, required this.type, required this.value})
      : super(key: key);
  @override
  State<OnaListUI> createState() => _OnaListUIState();
}

class _OnaListUIState extends State<OnaListUI> {
