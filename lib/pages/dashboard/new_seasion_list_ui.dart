...
class NewSeasonListUI extends StatefulWidget {
  final String type, value;
  const NewSeasonListUI({Key? key, required this.type, required this.value})
      : super(key: key);
  @override
  State<NewSeasonListUI> createState() => _NewSeasonListUIState();
}

class _NewSeasonListUIState extends State<NewSeasonListUI> {
